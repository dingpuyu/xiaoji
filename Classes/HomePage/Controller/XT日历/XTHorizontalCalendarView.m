...
@interface XTHorizontalCalendarView (){
    CGSize _lastSize;
...
@implementation XTHorizontalCalendarView
...
- (void)setDate:(NSDate *)date
{
    ...
    if(!_leftView){
        _leftView = [XTCalendarPageView new];
        [self addSubview:_leftView];
        
        _centerView = [XTCalendarPageView new];
        [self addSubview:_centerView];
        
        _rightView = [XTCalendarPageView new];
...
- (NSUInteger)weekIndexWithDate:(NSDate *)date{
    XTCalendarPageView* pageView = (XTCalendarPageView*)_centerView;
    return [pageView weekIndexWithDate:date];
}
