...
- (void)commonInit
{
    ...
    _circleRatio = .9;
    _dotRatio = 1. / 9.;
    self.backgroundColor = [UIColor colorWithRed:0.98f green:0.98f blue:0.98f alpha:0.70f];
    {
        _circleView = [UIView new];
        [self addSubview:_circleView];
        
        _circleView.backgroundColor = [UIColor colorWithRed:0.17f green:0.80f blue:0.80f alpha:1.00f];
    ...
    
    {
        ...
        _textLabel.textColor = [UIColor colorWithRed:0.32f green:0.32f blue:0.32f alpha:1.00f];
    ...
    
    {
        ...
        _lunarLabel.textColor = [UIColor colorWithRed:0.32f green:0.32f blue:0.32f alpha:1.00f];
...
- (void)layoutSubviews
{
    ...
    _blueCircleView.layer.borderColor = [UIColor colorWithRed:0.17f green:0.80f blue:0.80f alpha:1.00f].CGColor;
